...
public class RecyclerViewLoadMoreView extends LoadMoreView<RecyclerView.OnScrollListener> {
    ...
    public RecyclerViewLoadMoreView(final RecyclerView recyclerView, final RecyclerView.Adapter adapter, final boolean isBottomBar) {
        this(recyclerView,new NormalLoadMoreFooterAdapter(recyclerView.getContext(),adapter),isBottomBar);
    }

    public RecyclerViewLoadMoreView(RecyclerView recyclerView, AbsLoadMoreFooterAdapter loadMoreFooterAdapter, boolean hasBlankBottom){
