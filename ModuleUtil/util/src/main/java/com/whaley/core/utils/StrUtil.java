...
public final class StrUtil {
     ...
     * @return 字符串的长度
     */
    public static int lengthWithChineseSize3(String str) {
        int valueLength = 0;
        String chinese = "[\u0391-\uFFE5]";
        /* 获取字段值的长度，如果含中文字符，则每个中文字符长度为2，否则为1 */
        if (!isEmpty(str)) {
    ...
    public static String convertStreamToString(InputStream is) {
        ...
        try {
            ...
            Logger.e(e, "convertStreamToString");
        } finally {
            try {
                is.close();
            } catch (IOException e) {
